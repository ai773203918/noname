const translates = {
	...
	dcsbjunmou: "隽谋",
	dcsbjunmou_info: "转换技。①游戏开始时，你可以转换此技能状态；②一张牌结算结束后，若此牌的目标包括你，你可以选择一张手牌，阳：此牌视为无距离次数限制的火【杀】并摸一张牌（你可额外摸一张牌并令此技能本阶段失效）；阴：此颜色的牌不计入手牌上限并横置一名角色（你可额外横置一名角色并令此技能本阶段失效）。",
	dcsbzhanyan: "绽炎",
	...
	dcsbyizhen: "疑阵",
	dcsbyizhen_info: "其他角色使用牌指定你为目标后，若此牌花色在你你手牌中：唯一最多，你弃置此花色的一张牌；最少，此牌结算后你获得之。",
	xuwen: "徐妏",
	dcfuhui: "赋绘",
