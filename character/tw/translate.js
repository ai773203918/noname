...
const translates = {
	...
	twsb_xingshang: "行殇",
	twsb_xingshang_info: "一名角色死亡时，你可以分配其区域里的牌。出牌阶段结束时，你可将一名角色区域里的牌数弃置至与其体力值相等，然后你可使用至多X张其以此法弃置的牌（X为其体力值）。",
	twsb_fangzhu: "放逐",
	twsb_fangzhu_info: `①你受到伤害后，若为伤害来源本轮首次对你造成伤害，你可选择一项：1.令其非锁定技失效并获得${get.poptip("twyuanbu")}直到其下个回合结束；2.令其不能使用或打出当前手牌直到其下个回合结束。②每轮限一次，一名角色的回合开始时，你可令一名角色与其下家交换座次（不能包含当前回合角色）。`,
	twyuanbu: "远步",
	twyuanbu_info: "锁定技，你的手牌上限、计算与其他角色的距离、其他角色计算与你的距离+X（X为其他存活角色数且至多为4）。",  
	twsb_songwei: "颂威",
	twsb_songwei_info: "主公技，锁定技，其他魏势力角色回合开始时，你摸X张牌（X为本轮未执行过回合的角色且至多为3）。",
	tw_simashi: "TW司马师",
