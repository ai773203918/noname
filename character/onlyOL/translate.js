const translates = {
    ...
    olquanyu_baili: "百里",
    olquanyu_liuxing: "流星",
    olquanyu_info: "锁定技，每轮开始时，你令所有角色同时选择一项其未选择过的“权御”效果：白虹：基础伤害改为2；青冥：额外指定一个目标；辟邪：无视防具；紫电：不可响应；百里：额外结算一次；流星：无次数限制且不计入使用次数。然后你使用的【杀】均执行你本轮所选的“权御”效果。",
    oltianen: "天恩",
    oltianen_info: "锁定技，每回合各限一次，你使用牌指定唯一目标后：若本轮你与其选择的“权御”效果不同，你随机弃置其一张牌，对其发动一次〖权御〗；若与你相同，你获得一张【杀】。",
    olqiangang: "乾纲",
    olqiangang_info: "出牌阶段，你可入魔，失去〖天恩〗，然后本局你使用指定唯一目标的【杀】均额外执行目标所选择过的“权御”效果。",
    ol_sb_guojia: "OL谋郭嘉",
