...
import JSZip from "../../_virtual/index5.js";
...
class Get extends GetCompatible {
  ...
  isFunctionParam(paramstr) {
    ...
    const canCreateFunction = exports.isSandboxRequired() && exports.importSandbox().Marshal.canCreateFunction;
  ...
  infoFuncOL(info) {
    ...
    try {
      ...
      if (exports.isSandboxRequired()) {
        ...
        const box = exports.currentSandbox();
        if (!box) {
