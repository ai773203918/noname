        ...
        edit_character_three: {
          ...
          onclick() {
            ...
            var saveInput = function(view) {
              ...
              try {
                var { character } = exports.exec2(code);
        ...
        edit_character: {
          ...
          onclick() {
            ...
            var saveInput = function(view) {
              ...
              try {
                var { character } = exports.exec2(code2);
    ...
    ws: {
      ...
      onmessage: function(messageevent) {
        ...
        try {
          ...
          if (game.sandbox) {
            exports.enterSandbox(game.sandbox);
          }
          try {
    ...
    client: {
      ...
      exec: function(func) {
        ...
        if (typeof func == "function") {
          const isMarshalled = exports.isSandboxRequired() && exports.importSandbox().Domain.current.isFrom(func);
